<script lang="ts">
  ...
  import { classList, withoutElement } from "@web-std/common/general";

  import Add from "@web-std/icons/Add.svelte";
  import Delete from "@web-std/icons/DeleteBin.svelte";
  import Menu from "@web-std/icons/Menu.svelte";
