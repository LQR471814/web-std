<script lang="ts">
  ...
  import Add from "~/icons/components/System/Add.svelte";
  import Delete from "~/icons/components/System/DeleteBin.svelte";
  import Menu from "~/icons/components/System/Menu.svelte";
